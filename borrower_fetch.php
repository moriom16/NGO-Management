...
$columns = array('first_name', 'last_name', 'address', 'contact', 'account', 'tax_id', '$id');
...
if(isset($_POST["search"]["value"]))
{
 ...
 OR tax_id LIKE "%'.$_POST["search"]["value"].'%" 
 OR nid LIKE "%'.$_POST["search"]["value"].'%" 
 ';
}
...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="account">' . $row["account"] . '</div>';
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="tax_id">' . $row["tax_id"] . '</div>';
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="nid">' . $row["nid"] . '</div>';;
