...
<html>
 ...
 <body>
  ...
  <div class="container">
   <br />
   <h3 align="center" style="margin-left:300px;">Insert Item</h3>
   <br />
   <div class="table-responsive col-lg-12 mx-auto"style="left:150px;">
    <table class="table table-bordered" id="crud_table">
     <tr>
      <th width="30%">Item Name</th>
      <th width="20%">Enter Quantity</th>
      <th width="25%">Select Unit</th>
      <th width="25%">Approx Cost(tk)</th>
